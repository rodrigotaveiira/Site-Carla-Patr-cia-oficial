...
const links = [
  ...
  { icon: TrendingUp, label: 'Evolução dos alunos', to: '/evolucao-admin', description: 'Como cada aluno está indo em redação, materiais e progresso.' },
  ...
  { icon: CalendarClock, label: 'Calendário do curso', to: '/calendario-admin', description: 'Aulas ao vivo, aulas liberadas, simulados e simuladões na agenda do aluno.' },
  { icon: CalendarDays, label: 'Mentoria individual', to: '/mentorias-admin', description: 'Cadastre horários de mentoria individual.' },
