...
import {
  BookCheck, BookMarked, CalendarDays, CircleHelp, FileCheck2, Files, Library, PencilLine, PenLine, Target, Video, Zap,
} from 'lucide-react'
...
const links = [
  ...
  { icon: Target, label: 'Simulados', to: '/conteudo-admin/simulados', description: 'PDFs da seção Simulados.' },
