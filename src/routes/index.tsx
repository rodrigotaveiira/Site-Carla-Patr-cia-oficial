...
const faqs = [
  ...
  ['Há acompanhamento individual?', 'Sim. Todos os planos incluem feedback, e a Mentoria Individual oferece encontros e plano de estudos totalmente personalizados.'],
]
