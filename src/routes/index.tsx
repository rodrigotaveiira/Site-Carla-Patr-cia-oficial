  ...
  return (
    <section className="section aprovados-section" id="aprovados">
      ...
      <motion.div className="aprovados-cta" {...reveal}>
        <b>Aprovados 2026.2</b>
        <p>Conheça alguns dos alunos que conquistaram seus resultados neste semestre.</p>
    ...
    <main className="site-shell">
      ...
      <section className="section about" id="sobre">
        <motion.div className="about-collage" {...reveal}>
          <div className="about-main-image"><img src="/carla-sobre.webp" alt="Professora Carla Patrícia Medina" width={1200} height={1600} loading="lazy" /></div>
      ...
      <footer>
        <div className="footer-main"><div className="footer-brand"><a className="brand" href="#inicio"><span className="brand-mark"><img src="/logo-icone.png" alt="Carla Patrícia Medina" /></span><span><b>Carla Patrícia Medina</b><small>Redação e Gramática</small></span></a><p>Sua aprovação começa por uma redação de excelência.</p><div className="socials"><a href="https://instagram.com/carlapatricia.medina" aria-label="Instagram"><Instagram /></a><a href="https://wa.me/5522999325306" aria-label="WhatsApp"><MessageCircle /></a><a href="mailto:contato.carlapatriciamedina@gmail.com" aria-label="E-mail"><Mail /></a></div></div>
